...
import com.portfolio.gjs.Dto.dtoExperiencia;
import com.portfolio.gjs.Entity.Experiencia;
import com.portfolio.gjs.Security.Controller.Mensaje;
import com.portfolio.gjs.Service.SExperiencia;
...
public class CExperiencia {
    ...
    public ResponseEntity<?> update(@PathVariable("id") int id, @RequestBody dtoExperiencia dtoexp) {
        ...
        experiencia.setAnioIE(dtoexp.getAnioIE());
        experiencia.setAnioEE(dtoexp.getAnioEE());
